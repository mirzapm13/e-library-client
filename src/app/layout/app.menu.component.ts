...
import { recursiveMap } from '../shared/utils/recursive-map';
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    icon: 'pi pi-fw pi-pencil',
                    url: [
                        'https://www.figma.com/file/IeKkGeDwEmJeD6PbgANgSo/Preview-%7C-Freya-2.0.0?node-id=0%3A1&t=xfDlPQhWfSukbuaQ-1',
                    ],
                    target: '_blank',
                },
            ],
